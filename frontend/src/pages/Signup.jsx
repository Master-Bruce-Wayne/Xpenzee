...
function SignUp() {
  ...
  const handleFormSubmit = async (data) => {
    try {
      ...
      // Use data.name directly — response.user.displayName is null
      // immediately after createUserWithEmailAndPassword, even after
      // updateProfile updates auth.currentUser
      dispatch(
        setUser({
          fullName: data.name,
